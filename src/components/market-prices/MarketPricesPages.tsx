      ...
      <div className="mt-6 grid gap-4">
        ...
        <Card className="overflow-visible border-border/60">
          <CardContent className="p-0">
            <div className="sticky top-0 z-40 isolate grid gap-3 border-b bg-white p-4 shadow-md before:absolute before:inset-x-0 before:-top-32 before:h-32 before:bg-white before:content-[''] sm:p-5 lg:grid-cols-[180px_minmax(0,1fr)_auto_auto_auto]">
