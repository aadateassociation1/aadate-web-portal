...
const dict = {
  en: {
    ...
    "section.committee": "Board of Directors",
  ...
  mr: {
    ...
    "assoc.short": "मार्केट यार्ड आडते असोसिएशन, पुणे",
