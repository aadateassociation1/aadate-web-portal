...
export const OWNERS: Owner[] = [
  ...
  { id: "GO-003", name: "Mahesh Pawar", nameMr: "महेश पवार", mobile: "9876543212", username: "mahesh.pawar", email: "mahesh@example.com", gala: "B-201", section: "Onion & Potato Section", category: "Vegetables", business: "Pawar Kanda Batata Member", address: "Gala B-201, Market Yard", regDate: "2022-11-18", status: "approved" },
  ...
  { id: "GO-007", name: "Rajendra Chavan", nameMr: "राजेंद्र चव्हाण", mobile: "9876543216", username: "rajendra.chavan", email: "rajendra@example.com", gala: "D-401", section: "Wholesale Fruit", category: "Fruits", business: "Chavan Fruit Members", address: "Gala D-401, Market Yard", regDate: "2022-05-14", status: "approved" },
  ...
  { id: "GO-010", name: "Vijay Shinde", nameMr: "विजय शिंदे", mobile: "9876543219", username: "vijay.shinde", email: "vijay@example.com", gala: "E-502", section: "Vegetable Section E", category: "Vegetables", business: "Shinde Members", address: "Gala E-502, Market Yard", regDate: "2023-07-25", status: "approved" },
  // pending
  ...
  // rejected
  { id: "GO-016", name: "Sanjay Kadam", nameMr: "संजय कदम", mobile: "9876500016", username: "sanjay.kadam", email: "sk@example.com", gala: "H-802", section: "Vegetable", category: "Vegetables", business: "Kadam Members", address: "Gala H-802", regDate: "2026-06-01", status: "rejected" },
  ...
  // blacklisted
  { id: "GO-018", name: "Rahul Yadav", nameMr: "राहुल यादव", mobile: "9876500018", username: "rahul.yadav", email: "ry@example.com", gala: "I-902", section: "Vegetable", category: "Vegetables", business: "Yadav Members", address: "Gala I-902", regDate: "2022-01-01", status: "blacklisted" },
...
export const MARKET_UPDATES: MarketUpdate[] = [
  ...
  { id: "MU-009", title: "Rain alert for Members", titleMr: "व्यापाऱ्यांसाठी पाऊस इशारा", category: "Weather alert", summary: "Heavy rain expected next 3 days - cover perishable stock.", date: "2026-07-24", publishedBy: "User Admin", views: 723, emergency: true },
...
export const NOTICES: Notice[] = [
  ...
  { id: "N-8", number: "VPP/2026/38", title: "Government market circular", category: "Government Circular", description: "APMC circular regarding Member compliance.", date: "2026-07-14", attachment: "govt-circular.pdf" },
...
export const NEWS = [
  ...
  { id: "NEWS-5", title: "New drinking water RO plant", date: "2026-06-10", summary: "RO drinking water plant installed for Members and visitors." },
