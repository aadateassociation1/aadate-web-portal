            ...
            <Card className="overflow-hidden border-border/60 shadow-sm">
              <CardContent className="grid gap-0 p-0 md:grid-cols-[minmax(0,54%)_minmax(0,46%)]">
                <div className="relative min-h-[420px] bg-secondary sm:min-h-[500px] lg:min-h-[560px]">
                  ...
                  <div className="absolute left-5 top-5"><Badge className="px-3 py-1.5 text-sm font-bold bg-saffron text-saffron-foreground hover:bg-saffron">{chairmanCopy.current}</Badge></div>
                </div>
