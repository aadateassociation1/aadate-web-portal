  ...
  return (
    <SiteLayout>
      <section className="relative overflow-hidden bg-black">
        <video
          ref={bannerVideoRef}
          className="block aspect-video w-full object-cover object-center sm:aspect-auto sm:h-[calc(100svh-72px)] sm:min-h-[620px] sm:max-h-[760px] sm:object-[center_38%]"
          ...
          aria-label={isMr ? "\u0938\u0902\u091a\u093e\u0932\u0915 \u092e\u0902\u0921\u0933 \u0935\u094d\u0939\u093f\u0921\u093f\u0913 \u092c\u0945\u0928\u0930" : "Board of Directors video banner"}
        />
      </section>
