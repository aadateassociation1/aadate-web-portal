...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "VPP Market Yard — Digital Portal for Gala Owners" },
      { name: "description", content: "Connecting 850+ gala owners with market yard administration. Market updates, notices, complaints, official documents." },
      { property: "og:title", content: "VPP Market Yard — Digital Portal for Gala Owners" },
      { property: "og:description", content: "Secure digital platform for gala owners of Vishal Purandhar Patasanstha Market Yard." },
    ],
  }),
  component: Home,
});
        ...
        <div className="container-page grid gap-10 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              Vishal Purandhar Patasanstha Market Yard Owners Association represents over 850 gala owners
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {["Transparent complaint workflow", "Digital notice archive", "Bilingual EN / मराठी", "Verified gala owner accounts"].map((f) => (
      ...
      <section className="py-16 md:py-20">
        <div className="container-page">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 font-display text-3xl font-bold text-primary-dark sm:text-4xl">
              Everything a gala owner needs, in one portal
            </h2>
          </div>
        ...
        <div className="container-page">
          <div className="hero-gradient rounded-3xl px-6 py-14 md:px-14 md:py-16 text-center text-white shadow-xl">
            ...
            <div className="mt-8 flex flex-wrap justify-center gap-3">
              ...
              <Button asChild size="lg" variant="outline" className="border-white/40 bg-white/10 text-white hover:bg-white hover:text-primary-dark">
                <Link to="/login">Gala Owner Login</Link>
              </Button>
            </div>
          </div>
        </div>
