...
export const Route = createFileRoute("/notices")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Official notices, circulars and downloadable documents for gala owners." },
            ...
            <>
              ...
              <div className="rounded-lg border p-4">
                ...
                <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                  This notice is issued by the association for gala owners and market yard members. Download the notice for offline reference.
                </p>
              </div>
